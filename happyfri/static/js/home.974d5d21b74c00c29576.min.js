webpackJsonp([1, 3], {
		...
		t.default = {
			...
			methods: (0, a.default)({}, (0, o.mapActions)(["addNum", "initializeData"]), {
				...
				submitAnswer: function () {
					null !== this.choosedNum ? (this.addNum(this.choosedId), clearInterval(this.timer), this.$router.push(
						"score")) : alert("您还没有选择答案哦")
				}
			}),
			created: function () {
	...
	38: function (e, t, A) {
		...
		e.exports = !r || A(8)(function () {
			...
			for (var A = o(e), r = arguments.length, l = 1, m = n.f, u = a.f; r > l;)
				for (var c, d = s(arguments[l++]), f = m ? i(d).concat(m(d)) : i(d), B = f.length, p = 0; B > p;) u.call(d, c =
					f[p++]) && (A[c] = d[c]);
			return A
		} : r
	},
		...
		e.exports = {
			render: function () {
				var e = this,
					t = e.$createElement,
					A = e._self._c || t;
				return A("section", [A("header", {
					staticClass: "top_tips"
				}, ["home" == e.fatherComponent ? A("span", {
					staticClass: "num_tip"
				}, [e._v(e._s(e.level))]) : e._e(), e._v(" "), "item" == e.fatherComponent ? A("span", {
					staticClass: "num_tip"
				}, [e._v("题目" + e._s(e.itemNum))]) : e._e()]), e._v(" "), "home" == e.fatherComponent ? A("div", [A("div", {
					staticClass: "home_logo item_container_style"
				}), e._v(" "), A("router-link", {
					staticClass: "start button_style",
					attrs: {
						to: "item"
					}
				})], 1) : e._e(), e._v(" "), "item" == e.fatherComponent ? A("div", [A("div", {
					staticClass: "item_back item_container_style"
				}, [e.itemDetail.length > 0 ? A("div", {
					staticClass: "item_list_container"
				}, [A("header", {
					staticClass: "item_title"
				}, [e._v(e._s(e.itemDetail[e.itemNum - 1].topic_name))]), e._v(" "), A("ul", e._l(e.itemDetail[e.itemNum -
					1].topic_answer, function (t, i) {
					return A("li", {
						...
						class: {
							has_choosed: e.choosedNum == i
						}
					}, [e._v(e._s(e.chooseType(i)))]), e._v(" "), A("span", {
						staticClass: "option_detail"
					}, [e._v(e._s(t.answer_name))])])
					...
					staticClass: "submit_item button_style",
					on: {
