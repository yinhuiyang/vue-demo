			...
			return new u.default(function (a, r) {
				...
				if (s = window.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject, "GET" == e) {
					...
					(0, c.default)(i).forEach(function (e) {
						o += e + "=" + i[e] + "&"
					}), o = o.substr(0, o.lastIndexOf("&")), t = t + "?" + o, s.open(e, t, n), s.setRequestHeader(
						"Content-type", "application/x-www-form-urlencoded"), s.send()
				} else "POST" == e ? (s.open(e, t, n), s.setRequestHeader("Content-type", "application/x-www-form-urlencoded"),
					s.send((0, d.default)(i))) : r("error type");
